...
export const MEDICAL_FACTS = [
  ...
  "У человека около 650 мышц, и на жевание задействованы самые мощные относительно своего размера.",
  "Кости человека прочнее бетона: они выдерживают нагрузку до 18 000 кг на 1 см².",
  "В норме температура тела меняется в течение дня: минимум — около 4 утра, максимум — в 17–18 часов.",
  "Боль — защитный механизм: без способности чувствовать боль люди не замечают повреждений и живут значительно меньше.",
  "Эритроциты живут около 120 дней, а тромбоциты — всего 7–10 дней.",
  "Около 60% тела человека составляет вода, у новорождённых — до 80%.",
  "Правый лёгкое немного больше левого, потому что сердце занимает часть пространства слева.",
  ...
  "Первая успешная пересадка сердца выполнена Кристианом Барнардом в 1967 году в ЮАР.",
