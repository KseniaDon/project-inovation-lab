...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://cdn.poehali.dev/projects/e2f7351e-e666-4647-88af-b4a6ed42363d/bucket/07e6a93b-1feb-4637-bcab-fbcec24a04e3.png"
          alt="Background"
      ...
      <div className="relative z-10 text-center text-white flex flex-col items-center gap-5 sm:gap-7 px-4 sm:px-6 w-full max-w-2xl mx-auto">
        ...
        <motion.img
          ...
          className="w-28 sm:w-40 md:w-48 object-contain drop-shadow-[0_0_22px_rgba(220,38,38,0.4)]"
