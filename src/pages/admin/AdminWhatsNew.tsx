...
export default function AdminWhatsNew({ entries, saving, saved, onUpdate, onRemove, onAdd, onSave }: Props) {
  return (
    <div className="max-w-2xl flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">Записи отображаются на главной странице сайта. Если список пуст — блок скрыт.</p>
      </div>
