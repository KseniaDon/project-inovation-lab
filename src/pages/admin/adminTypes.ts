...
export const defaultInternExam: InternExam = {
  ...
  content: `<p>До получения допуска к лечению тебе нельзя абсолютно ничего. Лечить пациентов сможешь только тогда, когда получишь допуск к лечению.</p><p><strong>Чтобы получить допуск, тебе нужно сдать:</strong></p><ol><li><strong>Сдать устную речь</strong> — это бинды. Слово «Бинд» в РП мы не используем!</li><li><strong>Сдать Первичный Медицинский Экзамен (ПМЭ)</strong>, который включает: информацию о больнице, практический экзамен по выдаче препаратов, вопросы по Внутреннему уставу.</li><li>Сдать клятву врача.</li></ol>`,
