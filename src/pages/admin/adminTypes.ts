...
export const defaultMisPage: SimplePageData = {
  title: "МИС «Здоровье»",
  content: `<p>МИС «Здоровье» — это медицинская информационная система, куда ты загружаешь доказательства пролеченных пациентов перед подачей заявки на повышение. Без этого шага заявка не рассматривается.</p><p><strong>Что нужно заполнить в форме:</strong></p><ol><li><strong>Имя и Фамилия</strong> — твоё игровое имя и фамилия точно так же, как в бейдже.</li><li><strong>Ранг / должность</strong> — Интерн.</li><li><strong>Ссылка на скриншот #1–5</strong> — лечение каждого из 5 пациентов.</li><li><strong>Комментарий</strong> (необязательно) — любые пояснения к доказательствам.</li></ol><p><strong>Советы по скриншотам:</strong></p><ul><li>Скриншот делается через F8 или Steam Overlay (Shift+F12) — чтобы был виден чат и HUD с датой/временем.</li><li>Загружай скриншоты на imgur.com или на любой другой хостинг и вставляй прямую ссылку.</li><li>Каждый скриншот — отдельное лечение отдельного пациента.</li><li>На скриншоте должен быть виден твой бейдж (F6) и полный диалог от приветствия до прощания.</li></ul>`,
};
