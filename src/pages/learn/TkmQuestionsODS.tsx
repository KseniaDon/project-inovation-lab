...
export default function TkmQuestionsODS({ onNext, onBack }: Props) {
  ...
  const handleNext = () => {
    ...
    onNext({
      ...
      "2.2 Чем занимается ОДС?": q2,
      "2.3 На каком этаже проводятся услуги Травматолого-ортопедического центра?": q3,
    });
  };
  ...
  return (
    <div className="flex flex-col gap-5 max-w-2xl">
      <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-2">
        ...
        <h2 className="text-base font-bold mt-1">Ваше будущее отделение — ОДС.</h2>
