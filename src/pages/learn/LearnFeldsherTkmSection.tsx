  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 text-base text-foreground leading-relaxed">
        ...
        <p>
          Если же Вы успешно сдали тест — последует повышение в должности и перевод в выбранное Вами отделение, а также выплата премии за успешное завершение обучения в Отделении Интернатуры.
        </p>
      </div>
