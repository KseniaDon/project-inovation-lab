...
export default function LearnFeldsherKsmpSection({ go }: Props) {
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Единая рамка: заголовок + все виды транспорта */}
      <div className="border border-border rounded-lg p-5 sm:p-6 flex flex-col gap-6">

        <h2 className="text-base font-semibold text-center">Внешность транспорта и его предназначение</h2>
