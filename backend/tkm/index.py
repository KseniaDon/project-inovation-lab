...
GOOGLE_FORM_ENTRIES = {
    ...
    "2.2 Чем занимается ОДС?": "entry.1801011208",
    "Чем занимается ОДС?": "entry.1801011208",
    ...
    "2.3 На каком этаже проводятся услуги Стоматологической поликлиники «Дентист»?": "entry.1217621579",
    "На каком этаже проводятся услуги Стоматологической поликлиники «Дентист»?": "entry.1217621579",
    "2.3 На каком этаже проводятся услуги Травматолого-ортопедического центра?": "entry.1902761618",
    "На каком этаже проводятся услуги Травматолого-ортопедического центра?": "entry.1902761618",
