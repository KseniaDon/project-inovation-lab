...
GOOGLE_FORM_ENTRIES = {
    ...
    "2.3 На каком этаже проводятся услуги Травматолого-ортопедического центра?": "entry.446046504",
    "На каком этаже проводятся услуги Травматолого-ортопедического центра?": "entry.446046504",
